...
import { createUser,getUserByUserId } from '../Models/user';
...
// Secret key for JWT
const secretOrPrivateKey = "45c33959ea49730f3ab4e92583c0812104c6dec0a23949cbbb451d90fe56cca2925da4c7777263612fe7fd7a53412e4f74aff2975d637617b779d91d22f86085"
...
authRouter.post('/signup', async (req, res) => {
    try {
        ...
        // Create a new user
        await createUser(userId,email,age,password);
